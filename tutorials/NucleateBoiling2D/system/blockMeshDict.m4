...
vertices        
(
	//Bot Face (z = -1.2E-6, angled for ~2.5 degree wedge)
	(0                    0                  -1.2E-6)     //00
	(R_c                  0                  -1.2E-6)     //01
	(0                    H_c                -1.2E-6)     //02
	(R_c                  H_c                -1.2E-6)     //03
	(R_m                  H_c                -1.2E-6)     //04
	(0                    calc(H_c+H_m)      -1.2E-6)     //05
	(R_c                  calc(H_c+H_m)      -1.2E-6)     //06
	(R_m                  calc(H_c+H_m)      -1.2E-6)     //07
	//Top Face (z = 1.2E-6, angled for ~2.5 degree wedge)
	(0                    0                  1.2E-6)      //08
	(R_c                  0                  1.2E-6)      //09
	(0                    H_c                1.2E-6)      //10
	(R_c                  H_c                1.2E-6)      //11
	(R_m                  H_c                1.2E-6)      //12
	(0                    calc(H_c+H_m)      1.2E-6)      //13
	(R_c                  calc(H_c+H_m)      1.2E-6)      //14
	(R_m                  calc(H_c+H_m)      1.2E-6)      //15
);
